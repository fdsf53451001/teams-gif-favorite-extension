...
The extension does not collect, sell, rent, or share personal information with the developer.

The extension does not send analytics, telemetry, usage logs, chat content, or favorite lists to any developer-operated server.
...
The extension does not load or execute remotely hosted code. All executable JavaScript is included in the extension package.
